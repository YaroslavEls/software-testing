...
class TestGameOfLife(unittest.TestCase):
	...
	def test_universe(self):
		...
		self.assertEqual(self.uni1.field, [['.', '.', '.', '.', '.', '.', '.', '.'], 
										   ['x', '.', '.', '.', '.', '.', '.', '.'], 
										   ['x', '.', '.', '.', '.', '.', '.', '.'], 
										   ['x', '.', '.', '.', '.', '.', '.', '.'], 
										   ['.', '.', '.', '.', '.', '.', '.', '.']])
		...
		self.assertEqual(self.uni2.field, [['x', 'x', '.', '.', '.', '.', '.', 'x'], 
										   ['.', '.', '.', '.', '.', '.', '.', '.'], 
										   ['.', '.', '.', '.', '.', '.', '.', '.'], 
										   ['.', '.', '.', '.', '.', '.', '.', '.'], 
										   ['.', '.', '.', '.', '.', '.', '.', '.']])
		...
		self.assertEqual(self.uni3.field, [['.', '.', '.', '.', '.', '.', '.', 'x'], 
										   ['.', '.', '.', '.', '.', '.', '.', 'x'], 
										   ['.', '.', '.', '.', '.', '.', '.', '.'], 
										   ['.', '.', '.', '.', '.', '.', '.', '.'], 
										   ['.', '.', '.', '.', '.', '.', '.', 'x']])
	...
	def test_evolution(self):
		...
		evolution(self.uni2)
		self.assertEqual(self.uni2.field, [['x', '.', '.', '.', '.', '.', '.', '.'], 
										   ['x', '.', '.', '.', '.', '.', '.', '.'], 
										   ['.', '.', '.', '.', '.', '.', '.', '.'], 
										   ['.', '.', '.', '.', '.', '.', '.', '.'], 
										   ['x', '.', '.', '.', '.', '.', '.', '.']])
		...
		evolution(self.uni3)
		self.assertEqual(self.uni3.field, [['x', '.', '.', '.', '.', '.', 'x', 'x'], 
										   ['.', '.', '.', '.', '.', '.', '.', '.'], 
										   ['.', '.', '.', '.', '.', '.', '.', '.'], 
										   ['.', '.', '.', '.', '.', '.', '.', '.'], 
										   ['.', '.', '.', '.', '.', '.', '.', '.']])
